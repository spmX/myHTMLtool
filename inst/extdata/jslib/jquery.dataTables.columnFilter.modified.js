...
* 
* Parameters:"
* @sPlaceHolder                 String      Place where inline filtering function should be placed ("foot", "head:before", "head:after"). Default is "tfoot"
...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" placeHolder="search" class="' + search_init + sCSSClass + '" value="' + inputvalue + '" rel="' + i + '"/>');
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" placeHolder="from" class="number_range_filter form-control" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" placeHolder="to" class="number_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
